    ...
    <span class="hide-icon" style="display: none;">-</span></a>
            ...
            <div class="user-session">
              ...
              <ul class="nav navbar-nav navbar-right">
                  <li class="admin-info">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login as! <strong class="text-default"><?= $admin->level ?></strong></span></a>
                  </li>
      ...
      <div class="banner-top">
            <img style="width:100%; height: auto;" src="<?= base_url('assets/images/header.png') ?>">
      </div>